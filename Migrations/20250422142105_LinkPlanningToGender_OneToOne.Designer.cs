...
namespace EcoinverGMAO_api.Migrations
{
    ...
    [Migration("20250422142105_LinkPlanningToGender_OneToOne")]
    partial class LinkPlanningToGender_OneToOne
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EcoinverGMAO_api.Models.Entities.CultivePlanning", b =>
                {
                    b.HasOne("EcoinverGMAO_api.Models.Entities.Gender", "Genero")
                        .WithOne("CultivePlanning")
                        .HasForeignKey("EcoinverGMAO_api.Models.Entities.CultivePlanning", "IdGenero")
