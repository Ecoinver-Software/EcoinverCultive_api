...
namespace EcoinverGMAO_api.Migrations
{
    ...
    [Migration("20250513083939_CreateControlStockDetails")]
    partial class CreateControlStockDetails
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EcoinverGMAO_api.Models.ControlStock", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ControlStocks");
                });

            modelBuilder.Entity("EcoinverGMAO_api.Models.ControlStockDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EcoinverGMAO_api.Models.ControlStockDetails", b =>
                {
                    b.HasOne("EcoinverGMAO_api.Models.ControlStock", "ControlStock")
                        .WithMany("ControlStockDetails")
                        .HasForeignKey("IdControl")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
